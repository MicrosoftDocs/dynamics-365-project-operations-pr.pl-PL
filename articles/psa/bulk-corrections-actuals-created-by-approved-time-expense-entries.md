...
description: W tym artykule wyjaśniono, jak administrator może wprowadzić pojedyncze lub zbiorcze poprawki dla zatwierdzonych wcześniej wpisów czasu lub wydatków, jeśli rozliczenia nie zostały zakończone.
author: rumant
ms.date: 04/02/2020
ms.topic: article
...
Aby wykonać procedury z tego artykułu, należy mieć uprawnienia administratora.
