...
description: W tym artykule przedstawiono przykłady kontraktów dotyczących projektów, które można tworzyć dla różnych typów projektów i źródeł finansowania oraz sposób zarządzania kontraktami i klientami projektu fakturowania.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
