...
---
# <a name="manage-a-proforma-invoice"></a>Zarządzanie fakturą proforma
...
| **Firma zasobów** | Domyślnie jest ustawiona wartość z wartości źródłowej. Pole tylko do odczytu, które można edytować jako zablokowane. | To pole można edytować w nowym szczególe wiersza faktury, który nie jest poparty wartością źródłową. |
