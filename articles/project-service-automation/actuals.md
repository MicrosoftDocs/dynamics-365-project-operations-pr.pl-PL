...
## <a name="using-journals-to-record-costs"></a>Używanie dzienników do rejestrowania kosztów

W rozwiązaniu PSA arkusze umożliwiają rejestrowanie kosztów lub przychodów w klasach materiałów, opłat, czasu, wydatków lub transakcji podatkowych. Arkusz ma nagłówek, wiersze i akcję **Potwierdź**. Oto kilka scenariuszy, w których można korzystać z arkusza:
