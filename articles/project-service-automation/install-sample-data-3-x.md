...
- **\<EntitiesToEnableScheduling\>** określa encje, które powinny być włączone dla Rezerwowanie w Planowanie Microsoft Dynamics (alias Universal Resource Scheduling).
