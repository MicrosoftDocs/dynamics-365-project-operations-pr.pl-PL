---
title: Szczegóły nagłówka dla kontraktów opartych na projekcie
description: W tym artykule przedstawiono informacje pół i informacji oraz kontraktach opartych na projekcie w aplikacji Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
...
| Klient | Karta **Podsumowanie** | Odwołanie do rekordu firmy lub konta klienta. Gdy kontrakt jest tworzony z oferty, to pole jest kopiowane z odpowiedniego pola w ofercie. | Waluta w kontrakcie projektu jest domyślnie oparta na walucie klienta. Waluta może zostać zmieniona przed zapisaniem kontraktu. |
...
| Zarejestrowana ilość | Szczegóły wiersza opartego na projekcie | Czas: wszystkie ilości czasu dla rzeczywistych kosztów dla roli w projekcie zamapowanej na tę pozycję kontraktu. Wydatki: wszystkie ilości czasu dla kategorii wydatków w ramach wartości rzeczywistych kosztów w projekcie zamapowana na tę pozycję kontraktu. |
