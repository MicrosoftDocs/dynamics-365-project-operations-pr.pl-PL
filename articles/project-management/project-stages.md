...
description: W tym artykule przedstawiono informacje o etapach projektu dostępnych w aplikacji Microsoft Dynamics Project Operations.
author: ruhercul
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Gdy wygrywasz ofertą związaną z projektem i kiedy projekt przechodzi do fazy **Kontrakt**, etap projektu zostaje aktualizowany do **Planowanie**. Gdy projekt jest na etapie **Plan**, na karcie **Sprzedaż** na stronie **Encja projektu** widać szczegóły umowy.
