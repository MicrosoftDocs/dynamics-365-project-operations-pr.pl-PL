...
- Jeśli tworzysz nowy szablon, musisz dodać kolumnę, aby wspierać czas i koszty międzyfirmowe. Wybierz opcję **Dodaj kolumnę warunkową** i wprowadź nazwę kolumny, na przykład **LegalEntity**. Wprowadź warunek dla kolumny, gdzie, jeśli **msdyn\_contractorganizationalunitid.msdyn\_name** jest \<organizational unit\>, następnie \<wprowadź firmę\>;przeciwnym razie wartość null.
