...
description: W temat wyjaśniono, w jaki sposób pojęcie pochodzenia transakcji jest używane do łączenia wartości rzeczywistych z oryginalnymi rekordami źródłowymi, na przykład do wprowadzania czasu, wprowadzania wydatków lub dzienników użycia materiałów.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
