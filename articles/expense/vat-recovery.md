...
description: W tym artykule wyjaśniono, jak otrzymywać zwroty z kwalifikujących się transakcji zawierających podatek od towarów i usług (VAT).
author: suvaidya
ms.date: 10/10/2020
ms.topic: article
